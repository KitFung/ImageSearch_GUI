...
QT_MOC_LITERAL(5, 45, 16), // "QVector<QString>"
QT_MOC_LITERAL(6, 62, 5) // "infos"

    },
    "SearchingThread\0doneSearch\0\0QVector<int>\0"
    "res\0QVector<QString>\0infos"
};
...
void SearchingThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->doneSearch((*reinterpret_cast< QVector<int>(*)>(_a[1])),(*reinterpret_cast< QVector<QString>(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (SearchingThread::*_t)(QVector<int> , QVector<QString> );
...
// SIGNAL 0
void SearchingThread::doneSearch(QVector<int> _t1, QVector<QString> _t2)
{
